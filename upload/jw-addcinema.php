...
Total movies: <?php echo mysql_num_rows($get_cinema); ?></td>
...
<?php
while($data_cinema = mysql_fetch_array($get_cinema)) {
...
$id = $_GET["id"];
$data_cinema = mysql_fetch_array(SQL_Query_exec("SELECT * FROM jwcinema WHERE id = '$id'"));
?>
...
//$name = mysql_real_escape_string($data->items[0]->snippet->title); 
$info = mysql_real_escape_string($_POST["info"]); 
//$info = mysql_real_escape_string($data->items[0]->snippet->description); 
