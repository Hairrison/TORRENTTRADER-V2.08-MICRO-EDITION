<?php
$site_config = array();
$site_config['ttversion'] = '2.08 Micro Edition';		//DONT CHANGE THIS!
...
// Main Site Settings
$site_config['SITENAME'] = 'yoursite.com';					//Site Name
$site_config['TORRENTCOMMENT'] = 'Your Mom';					//Just something stupid to add. Found in torrents-upload around line 253
$site_config['SITEEMAIL'] = 'yoursite.com';		//Emails will be sent from this address, or appear as tho they did if using gmail and pear
...
$site_config['announce_list'] = "http://yoursite.com/announce.php"; //seperate via comma
...
$site_config['CONFIRMEMAIL'] = false;		//Enable / Disable Signup confirmation email //for private site, set true
...
$site_config['new_member_invites'] = 0 ; 		// Every new user will get 0 invites to start with. Change this to whatever floats your boat. Does not affect the regular giving of invites set by the you or the system
...
//Shoutbox selection
$site_config["AJSHOUTBOX"] = false; //True = Ajax shoutbox, False = Stock TT.2.08 shoutbox.
...
$site_config["mail_type"] = "pear"; //Use PEAR for Gmail, otherwise, use PHP
$site_config["mail_smtp_host"] = "smtp.gmail.com"; // SMTP server hostname. Google Gmail is smtp.gmail.com
$site_config["mail_smtp_port"] = "465"; // SMTP server port. Google Gmail uses 465
...
$site_config["mail_smtp_user"] = "user"; // SMTP username
...
$site_config["passhash_salt"] = "jsldorh72nd960pis538=$&*^#+=}90B$-(+)"; // Shouldn't be blank. At least 20 characters of random text.
