...
$path="/var/www/ft.netmicro.org/uploads/imdb/";
$ar=getDirectorySize($path);

echo "<b><center>Details for folder:</b> $path";
echo "<b><center>Total size :</b> ".sizeFormat($ar['size'])."<br>";
echo "<b><center>No. of files :</b> ".$ar['count']."<br><br/>";
	...
	echo "<center>".T_("VERSION_MYSQL").": <b>" . $mysqlver . "</b><br />".T_("VERSION_PHP").": <b>" . phpversion() . "</b><br />".T_("VERSION_APACHE").": <b>" . $aversion . "</b></center><hr/>";
...
<tr>
    ...
    <td align="center"><a href="admincp.php?action=freetorrents"><img src="images/admin/free_leech.png" border="0" width="118" height="80" alt="" /><br />Freeleech Torrents<?php /*echo T_("TORRENTS_FREE_LEECH");*/ ?></a><br /></td>
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
...
<tr>
    ...
    <td align="center"><a href="admincp.php?action=users"><img src="images/admin/simple_user_search.png" border="0" width="118" height="80" alt="" /><br />Simple User Search<br /></a></td>  
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=privacylevel"><img src="images/admin/privacy_level.png" border="0" width="118" height="80" alt="" /><br />Privacy Level<br /></a></td>     
    <td align="center"><a href="admincp.php?action=pendinginvite"><img src="images/admin/pending_invited_user.png" border="0" width="118" height="80" alt="" /><br />Pending Invited Users<br /></a></td>    
    <td align="center"><a href="admincp.php?action=invited"><img src="images/admin/invited_user.png" border="0" width="118" height="80" alt="" /><br />Invited Users<br /></a></td>    
    <td align="center"><a href="admincp.php?action=sqlerr"><img src="images/admin/sql_error.png" border="0" width="118" height="80" alt="" /><br />SQL Error<br /></a></td>  
     <td align="center"><a href="admincp.php?action=massmail"><img src="images/admin/massmail.png" border="0" width="118" height="80" alt="" /><br />Mass Mailer<br /></a></td>
...
<tr>
    ...
    <td align="center"><a href="admincp.php?action=referer"><img src="images/admin/referal.png" border="0" width="118" height="80" alt="" /><br />Referer's<br /></a></td>  
	<td align="center"><a href=jw-addcinema.php><img src="images/movie-icon.png" border="0" width="118" height="80" alt="" /><br />Add Movies<br /></a></td> 
   ...
   <td align="center"><a href="inactiveusers.php"><img src="images/admin/inactiveusers.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("USURSINACTIVE"); ?><br /></a></td>
   <td align="center"><a href="findnotconnectable.php"><img src="images/admin/connectable.png" border=0 width=118 height=80 alt="" /><br /><?php echo T_("NOT_CONNECT"); ?><br /></a></td>
    </tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="clients.php"><img src="images/admin/clients.png" border=0 width=118 height=80 alt="" /><br /><?php echo T_("CLIENTS"); ?><br /></a></td>
    <td align="center"><a href="upload-stats.php"><img src="images/admin/uploadstats.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("UPLOAD_STATS"); ?><br /></a></td>
    <td align="center"><a href="globaltheme.php"><img src="images/admin/globaltheme.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("SET_ALL_USER_THEMES"); ?><br /></a></td>
</tr>    
</table>
...
if ($action=="news" && $do=="edit"){
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if ($returnto != "")
			...
			show_error_msg(T_("COMPLETED"),T_("CP_NEWS_ITEM_WAS_EDITED_SUCCESS"), 1);
	} else {
...
if ($action == "forum") {
    ...
    <td>".T_("FORUM_ALLOW_GUEST_READ").":</td><td align='right'><input type="radio" name="guest_read" value="yes" <?php echo $r["guest_read"] == "yes" ? "checked='checked'" : ""?> />Yes, <input type="radio" name="guest_read" value="no" <?php echo $r["guest_read"] != "yes" ? "checked='checked'" : ""?> />No</td></tr>
...
if ($action == "referer")
{
          ...
          $res = SQL_Query_exec("SELECT * FROM `referer` ORDER BY `count` DESC $limit");
