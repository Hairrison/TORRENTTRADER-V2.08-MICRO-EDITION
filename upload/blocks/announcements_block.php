...
//	$num_donatemessages = $arr_donatemessages[0];
	...
	if (($CURUSER["announce_read"] == "no" && $arr = announcement()) || ($hnr2 > 0) || ($num_reports > 0) || ($num_staffmessages > 0) || ($num_donatemessages > 0) || ($unreadmail > 0))
	{
		...
		if ($unreadmail){
			...
			$arr_messages = mysql_fetch_row($res_messages);
