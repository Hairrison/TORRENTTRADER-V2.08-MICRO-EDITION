...
//
//  TorrentTrader v2.x
//   $LastChangedDate: 2016-06-16 19:13:35
//      $LastChangedBy: MicroMonkey
//	
...
<!--			<input type="radio" name="cookies" value="1"  /> Standard (cookies)<br/> -->
	...
	<ul>
	<li>Our RSS feeds are properly validated by true RSS 2.0 XML Parsing Standards. Visit <a rel="prettyPhoto[iframes]" href="https://www.feedvalidator.org/check.cgi?url=<?php echo ''.$site_config["SITEURL"].'' ?>/rss.php?iframe=true" target= "blank">FeedValidator.org</a> to validate.</li>
...
while ($row = mysql_fetch_array ($res)){ 
	list($image1,$id,$name,$size,$category,$added,$leechers,$seeders,$catname) = $row; 
