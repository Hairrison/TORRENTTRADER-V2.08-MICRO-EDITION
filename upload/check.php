...
//  TorrentTrader v2.x
//      $LastChangedDate$
//      $LastChangedBy$ MicroMonkey 12-16-2017
//
...
<head>
<title>Server config Check</title>
...
<body>
<center>
<br /><b>Config Check for 2.08 Micro edition<br />v1.7 - TorrentialStorm<br /><br /></b>
...
<tr>
	<td>&nbsp; - <font color= 'red'><b>openSSL module (Required for torrent downloads!)</b></font></td>
...
<p>In order to function correctly it needs to be able to access or write to certain files or directories.<br />
If you see "Unwriteable" you need to change the permissions on the file or directory to 777 (directories) or 666 (files) so that the scripts can write to it.
