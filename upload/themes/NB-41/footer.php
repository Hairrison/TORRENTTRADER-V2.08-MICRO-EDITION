      ...
      <table id="footer" width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td align="center">
            ...
            print ("<br /><a href=\"http://www.torrenttrader.org\" target=\"_blank\">www.torrenttrader.org</a> -|- <a href='rss.php' target=\"_blank\"><img src='".$site_config["SITEURL"]."/images/icon_rss.gif' border='0' width='13' height='13' alt='' /></a> -|- <a href='rss.php' target=\"_blank\">".T_("RSS_FEED")."</a> -|- <a href='rss.php?custom=1'>".T_("FEED_INFO")."</a><br />Theme By: <a href='http://nikkbu.info' target='_blank'>Nikkbu</a>");
            //
            // *************************************************************************************************************************************
            //			PLEASE DO NOT REMOVE THE POWERED BY LINE, SHOW SOME SUPPORT! WE WILL NOT SUPPORT ANYONE WHO HAS THIS LINE EDITED OR REMOVED!
            // *************************************************************************************************************************************
